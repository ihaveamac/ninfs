...
if [[ `uname -s` = Darwin ]]; then
    ...
    cp ninfs/data/32x32.png build/ninfs.iconset/icon_16x16@2x.png
    cp ninfs/data/32x32.png build/ninfs.iconset/icon_32x32.png
    cp ninfs/data/64x64.png build/ninfs.iconset/icon_32x32@2x.png
    cp ninfs/data/128x128.png build/ninfs.iconset/icon_128x128.png
    cp ninfs/data/1024x1024.png build/ninfs.iconset/icon_512x512@2x.png

    convert ninfs/data/1024x1024.png -resize 256x256 build/256x256_gen.png
    convert ninfs/data/1024x1024.png -resize 512x512 build/512x512_gen.png
