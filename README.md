...
## Setup
For 3DS types, The ARM9 bootROM is required. You can dump it using boot9strap by holding START+SELECT+X, which can be set up by [3DS Hacks Guide](https://3ds.hacks.guide). It is checked in order of:
